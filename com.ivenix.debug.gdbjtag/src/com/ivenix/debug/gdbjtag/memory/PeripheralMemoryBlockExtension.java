...
package com.ivenix.debug.gdbjtag.memory;

import com.ivenix.debug.core.SystemJob;
import com.ivenix.debug.gdbjtag.Activator;
import com.ivenix.debug.gdbjtag.datamodel.PeripheralDMContext;
import com.ivenix.debug.gdbjtag.datamodel.PeripheralDMNode;
import com.ivenix.debug.gdbjtag.datamodel.SvdPeripheralDMNode;
import com.ivenix.debug.gdbjtag.dsf.GnuArmCommandFactory;
import com.ivenix.debug.gdbjtag.services.IPeripheralMemoryService;
import com.ivenix.debug.gdbjtag.viewmodel.peripheral.PeripheralGroupVMNode;
import com.ivenix.debug.gdbjtag.viewmodel.peripheral.PeripheralRegisterFieldVMNode;
import com.ivenix.debug.gdbjtag.viewmodel.peripheral.PeripheralRegisterVMNode;
import com.ivenix.debug.gdbjtag.viewmodel.peripheral.PeripheralTopVMNode;
import com.ivenix.debug.gdbjtag.viewmodel.peripheral.PeripheralTreeVMNode;
...
public class PeripheralMemoryBlockExtension extends PlatformObject
	...
	public PeripheralMemoryBlockExtension(DsfMemoryBlockRetrieval memoryBlockRetrieval,
		...
		fConnections = new ArrayList<Object>();
	...
	private List<PeripheralMemoryRegion> createRegionsList() {
		...
		list = new LinkedList<PeripheralMemoryRegion>();
